...
?>
                    <?php if($pago->getUser()->getAdmin() == Auth::user()->getId() || Auth::user()->getId() == 1): ?>
                        <tr>
                            ...
                            <td>
                                <?php echo HTML::link(action('ReportarPagos\ReportarPagosController@getView', [ 'id' => $pago->getid() ]), '<i class="icmn-file-eye2" aria-hidden="true"></i>', [ 'class' => 'btn btn-info', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'data-original-title' => 'Ver' ]); ?>
