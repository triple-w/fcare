            ...
            <div id="middle-wizard">
                <div class="step row">
                    <div class="col-md-12">
                        ...
                        <?php echo BootForm::text('fechaFactura', 'Fecha de expedición', null, [ 'class' => 'datetimepicker' ]); ?>
...
?>
                    <div class="cont">
                        <div class="clone">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <?php echo BootForm::select('nProductosTipoImpuesto', '¿Desea desglosar el I.V.A.?', [ '0' => 'No', '1' => 'Si' ], [], [ 'id' => 'tipo-impuesto' ]); ?>
                            ...
                            <div class="contenedor-retenciones">
                                <div class="row rete">
                                    <div class="col-md-4">
                                        ...
                                        //$default = \App\Models\Facturas::getClavesImpuestos();
                                        ?>
                                        <?php echo BootForm::select('nRetenciones', 'Tipo de Retencion', $retenciones, [], [ 'id' => 'retenciones', 'class' => 'retenciones-tipo' ]); ?>
                ...
                <div class="step row">
                    ...
                    <?php echo BootForm::textarea('comentariosPDF', 'Comentarios PDF', null, [ 'class' => 'comentarios-pdf' ]); ?>

                    <?php echo BootForm::checkbox('incluirInfo', '¿Incluir información emisor/receptor en PDF?', null, null); ?>
