...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo BootForm::open(); ?>
        ...
        <?php echo BootForm::select('claveProdServ', 'Clave de Servicio', [], [], [ 'id' => 'clave-prod-serv', 'data-url' => 'productos/clave-prod-serv', 'requiered' ]); ?>

        <?php echo BootForm::select('claveUnidad', 'Clave de Unidad', [], [], [ 'id' => 'clave-unidad', 'data-url' => 'productos/clave-unidad' , 'requiered']); ?>
