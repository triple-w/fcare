...
?>
                <tr>
                    ...
                    <td>
                        <?php echo HTML::link('#', '<i class="icmn-file-empty" aria-hidden="true"></i>', [ 'class' => 'btn btn-default envio-facturas', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'data-original-title' => 'Envio por email', 'data-id' => $complemento->getId() ]); ?>

                        <?php echo HTML::link(action('Users\ComplementosV33Controller@getXml', [ 'id' => $complemento->getId() ]), '<i class="icmn-file-xml" aria-hidden="true"></i>', [ 'class' => 'btn btn-default', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'data-original-title' => 'XML Download' ]); ?>

                        <?php echo HTML::link(action('Users\ComplementosV33Controller@getPdf', [ 'id' => $complemento->getId() ]), '<i class="icmn-file-pdf" aria-hidden="true"></i>', [ 'class' => 'btn btn-default', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'data-original-title' => 'PDF Download' ]); ?>

                        <?php echo HTML::link(action('Users\ComplementosV33Controller@getInvoice', [ 'id' => $complemento->getId() ]), '<i class="icmn-file-eye" aria-hidden="true"></i>', [ 'class' => 'btn btn-default', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'data-original-title' => 'VER' ]); ?>

                        <?php if($complemento->getEstatus() === \App\Models\Complementos::TIMBRADA): ?>
                            <?php echo HTML::link(action('Users\ComplementosV33Controller@getCancelar', [ 'id' => $complemento->getId() ]), '<i class="icmn-cross" aria-hidden="true"></i>', [ 'class' => 'btn btn-danger eliminar', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'data-original-title' => 'CANCELAR' , 'data-title' => 'Cancelación de Pago', 'data-content' => 'Esta seguro de Cancelar el pago?' ]); ?>
