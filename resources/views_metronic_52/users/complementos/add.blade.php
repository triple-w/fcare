    ...
    <div id="survey_container">
        ...
        {!! BootForm::open([ 'id' => 'form-wizard' ]); !!}
            <div id="middle-wizard">
                <div class="step row">
                <div class="col-md-12"> 
                    {!! BootForm::text('fecha', 'Fecha de Complemento', null, [ 'class' => 'datetimepicker' ]) !!}
                    <h2>Cliente</h2>
                    @set('clientes', [])
                    ...
                    <div class="cont">
                        ...
                        <div class="clone">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    {!! BootForm::text('fechaPago', 'Fecha de Pago', null, [ 'class' => 'datetimepagos fechaPago' ]) !!}
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    {!! BootForm::select('tipoMonedaDR', 'Moneda del documento relacionado', [ 'MXN' => 'MXN', 'USD' => 'USD' ], [], [ 'class' => 'tipo-moneda', 'id' => 'select-tipo-monedaDR' ]) !!}
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="row opcionales">
                                <div class="col-md-4">
                                    {!! BootForm::text('numOp', 'Número de Operación/Referencia', null, ['class' => 'numOp', 'readonly'=>'readonly'])!!}
                                </div>
                                <div class="col-md-4">
                                    <!--{!! BootForm::select('bcoEmisor', 'Banco Emisor', \App\Models\Empleados::getBancos(), [], ['class' => 'bcoEmisor']) !!} -->
                                    {!! BootForm::text('bcoEmisor', 'RFC Banco Emisor', null, ['class' => 'bcoEmisor', 'readonly'=>'readonly']) !!}
                                </div>
                                <div class="col-md-4">
                                    {!! BootForm::text('ctaOrd', 'Cuenta Ordenante', null, ['class' => 'ctaOrd', 'readonly'=>'readonly']) !!}
                                </div>
                                
                            </div>
                            <div class="row opcionales">
                                <div class="col-md-4">
                                    <!--{!! BootForm::select('bcoReceptor', 'Banco Receptor', \App\Models\Empleados::getBancos(), [], ['class' => 'bcoReceptor']) !!}-->
                                    {!! BootForm::text('bcoReceptor', 'RFC Banco Receptor', null, ['class' => 'bcoReceptor', 'readonly'=>'readonly']) !!}
                                </div>
                                <div class="col-md-4">
                                    {!! BootForm::text('ctaBen', 'Cuenta Beneficiaria', null, ['class' => 'ctaBen', 'readonly'=>'readonly']) !!}
                                </div>
