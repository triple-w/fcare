...
@section('content')
    ...
    {!! BootForm::open() !!}
        {!! BootForm::select('claveProdServ', 'Clave de Servicio', [], [], [ 'id' => 'clave-prod-serv', 'data-url' => 'productos/clave-prod-serv', 'requiered' ]) !!}
        {!! BootForm::select('claveUnidad', 'Clave de Unidad', [], [], [ 'id' => 'clave-unidad', 'data-url' => 'productos/clave-unidad' , 'requiered']) !!}
