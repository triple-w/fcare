...
@section('scripts')
    ...
    {!! HTML::scriptLocal('webroot/js/limitless_14/facturasV33_add.js?v=1.1.4') !!}
        ...
        {!! BootForm::open([ 'id' => 'form-wizard' ]); !!}
            <div id="middle-wizard">
                <div class="step row">
                    <div class="col-md-12">
                        <h2>Tipo de CFDI</h2>
                        {!! BootForm::select('nombreComprobante', 'Nombre de Comprobante', \App\Models\Facturas::getNombresDocumentos(), null, [ 'class' => 'nombreComprobante' ]) !!}
                        {!! BootForm::text('fechaFactura', 'Fecha de expedición', null, [ 'class' => 'datetimepicker' ]) !!}
                        <h2>Serie y Folio</h2>
                    ...
                    <div class="cont">
                        <div class="clone">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    {!! BootForm::text('nDescuento', 'descuento', null, [ 'id' => 'descuento_producto' ]) !!}
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    {!! BootForm::select('nProductosTipoImpuesto', '¿Desea desglosar el I.V.A.?', [ '0' => 'No', '1' => 'Si' ], [], [ 'id' => 'tipo-impuesto' ]) !!}
                                </div>
                            </div>
                                ...
                                <div class="row rete">
                                    <div class="col-md-4">
                                        ...
                                        foreach ($impuestos as $impuesto) {
                                            //$tasa[$impuesto->id] = $impuesto->tasa;
                                            if ($impuesto->tipo == 'RETENCION') {
                                                $retenciones[$impuesto->id] = $impuesto->nombre;
                                            } elseif ($impuesto->tipo == 'TRASLADO') {
                                                $traslados[$impuesto->id] = $impuesto->nombre;
                                            }
                                        } 
                                        $default = \App\Models\Facturas::getClavesImpuestos();
                                        $retenciones = $default + $retenciones;
                                        $traslados = $default + $traslados;
                                        //$default = \App\Models\Facturas::getClavesImpuestos();
                                        ?>
                                        {!! BootForm::select('nRetenciones', 'Tipo de Retencion', $retenciones, [], [ 'id' => 'retenciones', 'class' => 'retenciones-tipo' ]) !!}
                                        <div class="mensaje-retenciones" style="color:red"></div>
                                    </div>
                                    <div class="col-md-4">
                                    {!! BootForm::text('nRetencionesTasa', 'Retenciones Tasa', '', [ 'id' => 'retenciones-tasa', 'class' => 'retenciones-tasa' ]) !!}
                            ...
                            <div class="contenedor-traslados">
                                <div class="row tras">
                                    <div class="col-md-4">
                                        {!! BootForm::select('nTrasladados', 'Trasladados Tipo', \App\Models\Facturas::getClavesImpuestos(), [], [ 'id' => 'trasladados', 'class' => 'traslados-tipo'  ]) !!}
                                        <div class="mensaje-traslados" style="color:red"></div>
                                    </div>
                                    <div class="col-md-4">
                                        {!! BootForm::text('nTrasladadosTasa', 'Trasladados Tasa', '', [ 'id' => 'trasladados-tasa', 'class' => 'traslados-tasa'  ]) !!}
                ...
                <div class="step row">
                    ...
                    {!! BootForm::select('tipoMoneda', 'Tipo de Moneda', \App\Models\Facturas::getTiposMonedas(), 'MXN', [ 'id' => 'select-tipo-moneda' ]) !!}
                    <div class="cont-tipo-moneda">
                        {!! BootForm::text('tipoCambio', 'Tipo de Cambio', null, [ 'class' => 'tipo-moneda' ]) !!}
                    </div>
                    {!! BootForm::select('metodoPago', 'Metodo de Pago', \App\Models\Facturas::getMetodosPago(), [], [ 'class' => 'metodo-pago' ]) !!}
                    ...
                    {!! BootForm::textarea('comentariosPDF', 'Comentarios PDF', null, [ 'class' => 'comentarios-pdf' ]) !!}
                    {!! BootForm::checkbox('incluirInfo', '¿Incluir información emisor/receptor en PDF?', null, null) !!}
