        ...
        <div class="invoice-block">
            ...
            <div class="col-md-6 text-right">
                <h1>FACTURA</h1>
                        ...
                        <h4>{{ empty($comprobante->getAttribute('serie')) ? $comprobante->getAttribute('Serie') : $comprobante->getAttribute('serie') }} - {{ empty($comprobante->getAttribute('folio')) ? $comprobante->getAttribute('Folio') : $comprobante->getAttribute('folio') }}</h4>
                ...
                <table class="table table-hover text-right">
                    ...
                    <tbody>
                        ...
                        @foreach ($factura->getImpuestos() as $impuesto)
                            ...
                            @endif
                            <tr>
                                <td colspan="4" class="text-right"><strong>{{ \App\Models\Facturas::getNombreImpuestos($impuesto->getImpuesto()) }}</strong></td>
