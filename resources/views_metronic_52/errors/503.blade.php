...
<html lang="en" >
	...
	<head>
        ...
        <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('/webroot/img/favicon/favicon-32x32.png') }}">
        <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('/webroot/img/favicon/favicon-16x16.png') }}">
...
{!! HTML::script('assets/demo/demo5/base/scripts.bundle.js') !!}
		<!--end::Base Scripts -->
	</body>
	<!-- end::Body -->
</html>
