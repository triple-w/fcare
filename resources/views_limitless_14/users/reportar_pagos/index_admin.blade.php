                ...
                <tbody>
                    @foreach ($pagos as $pago)
                        <tr>
                            ...
                            <td>
                                {!! HTML::link(action('ReportarPagos\ReportarPagosController@getView', [ 'id' => $pago->getid() ]), '<i class="icon-file-eye2" aria-hidden="true"></i>', [ 'class' => 'btn btn-info', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'data-original-title' => 'Ver' ]) !!}
                            </td>
                        </tr>
                    @endforeach
                </tbody>
