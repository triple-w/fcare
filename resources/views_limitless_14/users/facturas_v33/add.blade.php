            ...
            <div id="middle-wizard">
                <div class="step row">
                    <div class="col-md-12">
                        ...
                        {!! BootForm::date('fechaFactura', 'Fecha de expedición', null, [ 'class' => 'datetimepicker' ]) !!}
                        <h2>Serie y Folio</h2>
                    ...
                    <div class="cont">
                        <div class="clone">
                            ...
                            <div class="contenedor-retenciones">
                                <div class="row rete">
                                    <div class="col-md-4">
                                        {!! BootForm::select('nRetenciones', 'Tipo de Retencion', \App\Models\Facturas::getClavesImpuestos(), [], [ 'id' => 'retenciones', 'class' => 'retenciones-tipo' ]) !!}
